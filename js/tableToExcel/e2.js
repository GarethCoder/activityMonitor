 ...
 */
function generateArray(table, columnHeaders) {
    var out = [];
    ...
    for (var R = 0; R < rows.length; ++R) {
        ...
        if (count == 0) {
            let headers = [null];
            console.log("initial header push");
 ...
 */
function export_table_to_excel(mode, form, id, id2, headers) {
    var theTable = document.getElementById(id);
    var oo = generateArray(theTable, headers);
    var ranges = oo[1];
    /* original data */
    var data = oo[0];
    var ws_name = form;
